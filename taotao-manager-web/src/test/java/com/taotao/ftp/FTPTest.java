...
public class FTPTest {
	...
	public void testFtpUtil() throws Exception {
		...
		FtpUtils.uploadFile("192.168.1.133", 21, "ftpuser", "ftpuser", "/home/ftpuser/www/images", "2021/04/20", "111.wav", inputStream);
	}
	...
	public void testFTPClient() throws Exception{
		...
		boolean res = ftpClient.storeFile("1.jpg", localFile);
		System.out.println("上传是否成功:"+res);
		//关闭连接
		ftpClient.logout();
	}
}
